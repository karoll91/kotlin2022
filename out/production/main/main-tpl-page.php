...
<!-- ======= Clients Section ======= -->
<!--
    <section class="latest-news wow fadeInUp theme-bg-color bg-back">

      <div class="container">
  <div class="theme-title">
          <?/*if($sitelang == "uz"):*/?>
                <h2>QABUL 2021-2022</h2>
			<?/*elseif($sitelang == "ru"):*/?>
                <h2>ПРИЕМ 2021-2022</h2>
            <?/*elseif($sitelang == "en"):*/?>
                <h2>RECEPTION 2021-2022</h2>
            <?/*endif;*/?>
  </div>
  <div class="row">
      ...
      <div class="panel panel-default text-center">
        <?/*if($sitelang == "uz"):*/?>
			<div class="panel-heading">
			  <h3 class="h3_qabul">Bakalavr</h3>
			</div>
			<div class="panel-body">
			  <p>Ta'lim yo'nalishlari <strong>30</strong></p>
			  <p>Jami <strong>1800</strong></p>
			  <p>Davlat granti <strong>500</strong></p>
			  <p>To'lov-kontrakt <strong>1300</strong></p>
			</div>
			<div class="panel-footer">
			  <button class="btn btn-lg"><a href="https://jizpi.uz/abituriyent/bakalavriat/" class="h3_qabul">Batafsil</a></button>
			</div>
		<?/*elseif($sitelang == "ru"):*/?>
			<div class="panel-heading">
			  <h3 class="h3_qabul">Бакалавриат</h3>
			</div>
			<div class="panel-body">
			  <p>Направления и специальности образования <strong>30</strong></p>
			  <p>Всего <strong>1800</strong></p>
			  <p>Грант <strong>500</strong></p>
			  <p>Контракт <strong>1300</strong></p>
			</div>
			<div class="panel-footer">
			  <button class="btn btn-lg"><a href="https://jizpi.uz/abituriyent/bakalavriat/" class="h3_qabul">Подробно</a></button>
			</div>
		<?/*elseif($sitelang == "en"):*/?>
			<div class="panel-heading">
			  <h3 class="h3_qabul">Bachelor</h3>
			</div>
			<div class="panel-body">
			  <p>Directions and specialties of education <strong>30</strong></p>
			  <p>Total <strong>1800</strong></p>
			  <p>Grant <strong>500</strong></p>
			  <p>The contract <strong>1300</strong></p>
			</div>
			<div class="panel-footer">
			  <button class="btn btn-lg"><a href="https://jizpi.uz/abituriyent/bakalavriat/" class="h3_qabul">Detailed</a></button>
			</div>
		<?/*endif;*/?>
      </div>      
    </div>     
    <div class="col-sm-3 col-xs-12">
      <div class="panel panel-default text-center">
		<?/*if($sitelang == "uz"):*/?>
			<div class="panel-heading">
			  <h3 class="h3_qabul">Sirtqi ta'lim</h3>
			</div>
			<div class="panel-body">
			  <p>Ta'lim yo'nalishlari <strong>15</strong></p>
			  <p>Jami <strong>500</strong></p>
			  <p>Davlat granti <strong>0</strong></p>
			  <p>To'lov-kontrakt <strong>500</strong></p>
			</div>
			<div class="panel-footer">
			  <button class="btn btn-lg"><a href="https://jizpi.uz/abituriyent/sirtqi-talim/" class="h3_qabul">Batafsil</a></button>
			</div>
		<?/*elseif($sitelang == "ru"):*/?>	
			<div class="panel-heading">
			  <h3 class="h3_qabul">Заочное обучение</h3>
			</div>
			<div class="panel-body">
			  <p>Направления и специальности образования <strong>15</strong></p>
			  <p>Всего <strong>500</strong></p>
			  <p>Грант <strong>0</strong></p>
			  <p>Контракт <strong>500</strong></p>
			</div>
			<div class="panel-footer">
			  <button class="btn btn-lg"><a href="https://jizpi.uz/abituriyent/sirtqi-talim/" class="h3_qabul">Подробно</a></button>
			</div>
		<?/*elseif($sitelang == "en"):*/?>	
			<div class="panel-heading">
			  <h3 class="h3_qabul">Extramural education</h3>
			</div>
			<div class="panel-body">
			  <p>Directions and specialties of education <strong>15</strong></p>
			  <p>Total <strong>500</strong></p>
			  <p>Grant <strong>0</strong></p>
			  <p>The contract <strong>500</strong></p>
			</div>
			<div class="panel-footer">
			  <button class="btn btn-lg"><a href="https://jizpi.uz/abituriyent/sirtqi-talim/" class="h3_qabul">Detailed</a></button>
			</div>
		<?/*endif;*/?>
    ...
    <div class="col-sm-3 col-xs-12">
      <div class="panel panel-default text-center">
		<?/*if($sitelang == "uz"):*/?>	
			<div class="panel-heading">
			  <h3 class="h3_qabul">Magistratura</h3>
			</div>
			<div class="panel-body">
			  <p>Ta'lim yo'nalishlari <strong>14</strong></p>
			  <p>Jami <strong>89</strong></p>
			  <p>Davlat granti <strong>84</strong></p>
			  <p>To'lov-kontrakt <strong>5</strong></p>
			</div>
			<div class="panel-footer">
			  <button class="btn btn-lg"><a href="https://jizpi.uz/abituriyent/magistratura/" class="h3_qabul">Batafsil</a></button>
			</div>
		<?/*elseif($sitelang == "ru"):*/?>	
			<div class="panel-heading">
			  <h3 class="h3_qabul">Магистратура</h3>
			</div>
			<div class="panel-body">
			  <p>Направления и специальности образования <strong>19</strong></p>
			  <p>Всего <strong>89</strong></p>
			  <p>Грант <strong>84</strong></p>
			  <p>Контракт <strong>5</strong></p>
			</div>
			<div class="panel-footer">
			  <button class="btn btn-lg"><a href="https://jizpi.uz/abituriyent/magistratura/" class="h3_qabul">Подробно</a></button>
			</div>
		<?/*elseif($sitelang == "en"):*/?>	
			<div class="panel-heading">
			  <h3 class="h3_qabul">Magistracy</h3>
			</div>
			<div class="panel-body">
			  <p>Directions and specialties of education <strong>19</strong></p>
			  <p>Total <strong>89</strong></p>
			  <p>Davlat granti <strong>84</strong></p>
			  <p>The contract <strong>5</strong></p>
			</div>
			<div class="panel-footer">
			  <button class="btn btn-lg"><a href="https://jizpi.uz/abituriyent/magistratura/" class="h3_qabul">Detailed</a></button>
			</div>
		<?/*endif;*/?>	
      </div>      
    </div>  
	<div class="col-sm-3 col-xs-12">
      <div class="panel panel-default text-center">
		<?/*if($sitelang == "uz"):*/?>	
			<div class="panel-heading">
			  <h3 class="h3_qabul">Yo'nalishlar</h3>
			</div>
			<div class="panel-body">
			  <p>Ta'lim yo'nalish klassifikatorlari</p>
			  <p>Jami yo'nalishlar <strong>30</strong></p>
			  <p><strong>Siz qayirda</strong></p>
			  <p><strong>kim bo'lib ishlamoqchisiz?</strong></p>
			</div>
			<div class="panel-footer">
			  <button class="btn btn-lg"><a href="https://jizpi.uz/qabul/" class="h3_qabul">Batafsil</a></button>
			</div>
		<?/*elseif($sitelang == "ru"):*/?>	
			<div class="panel-heading">
			  <h3 class="h3_qabul">Специальностей</h3>
			</div>
			<div class="panel-body">
			  <p>Классификатор направлений и специальностий </p>
			  <p>Всего направления <strong>30</strong></p>
			  <p><strong>Где и кем Вы</strong></p>
			  <p><strong>хотите работать?</strong></p>
			</div>
			<div class="panel-footer">
			  <button class="btn btn-lg"><a href="https://jizpi.uz/qabul/" class="h3_qabul">Подробно</a></button>
			</div>
		<?/*elseif($sitelang == "en"):*/?>
			<div class="panel-heading">
			  <h3 class="h3_qabul">Specialties</h3>
			</div>
			<div class="panel-body">
			  <p>Classifier of directions and specialties</p>
			  <p>Total directions <strong>30</strong></p>
			  <p><strong>Where and by whom do</strong></p>
			  <p><strong>you want to work?</strong></p>
			</div>
			<div class="panel-footer">
			  <button class="btn btn-lg"><a href="https://jizpi.uz/qabul/" class="h3_qabul">Detailed</a></button>
			</div>
		<?/*endif;*/?>
      </div>      
    </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeInUp">
                <?if($sitelang == "uz"):?>
                    ...
                    <p>
                        Institut hududi 19100 m<sup>2</sup> maydonga ega bo’lib, unda 1500 o’rinli asosiy bino, 1000 o’rinli yangi o’quv –laboratoriya binosi, sport zali va 2 ta mini futbol maydoni, katta futbol maydoni, tennis, yengil atletika maydonlari joylashgan.
                    </p>
                <?elseif($sitelang == "ru"):?>
                    <h3><i class="fa fa-building-o" aria-hidden="true"></i> Институт сегодня</h3>
                    <p>
                        Территория института  19100 м<sup>2</sup>.  Главное здание на 1500 мест, новое учебно–лабораторное здание на 1000 мест, современный информационно ресурсный центр, спортивный городок включающий в себя спортивный зал, 2 мини-футбольных поля, футбольное поле, теннисный корт и  легкоатлетическая площадки.
                    </p>
                <?elseif($sitelang == "en"):?>
                    <h3><i class="fa fa-building-o" aria-hidden="true"></i> Institute buildings</h3>
                    <p>
                        The territory of the institute has an area of 19100 m<sup>2</sup>, which includes the main building with 1500 seats, a new training and laboratory building with 1000 seats, a gym and 2 mini football fields, a large football field, tennis, athletics fields.
                    </p>
                <?endif;?>
...
<div class="latest-news wow fadeInUp theme-bg-color">
    <div class="container">
        <div class="theme-title">
            <?if($sitelang == "uz"):?>
                <h2>Akademik innovatsiyalar granti</h2>
            <?elseif($sitelang == "ru"):?>
                <h2>Академический инновационный грант</h2>
            <?elseif($sitelang == "en"):?>
                <h2>Academic Innovation Grant</h2>
            <?endif;?>
...
<div class="latest-news wow fadeInUp theme-bg-color bg-back">
    <div class="container">
        ...
        <div class="post-wrapper row">
            ...
            ?>
            <?if($sitelang == "uz"):?>
                <a class="myButton" href="https://www.jizpi.uz/elektron-nashrlar/">Hammasini ko'rish</a>
            <?elseif($sitelang == "ru"):?>
                <a class="myButton" href="https://www.jizpi.uz/ru/elektron-nashrlar/">Посмотреть все</a>
            <?elseif($sitelang == "en"):?>
                <a class="myButton" href="https://www.jizpi.uz/en/elektron-nashrlar/">View all</a>
            <?endif;?>
