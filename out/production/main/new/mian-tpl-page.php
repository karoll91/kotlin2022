            ...
            <ul>
                ...
                <li data-index="rs-280" data-transition="zoomout" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-rotate="0"  data-saveperformance="off"  data-title="Sarlavha shu yerga kiradi" data-description="">
                    ...
                    <div class="tp-caption"
                        ...
                        <?if($sitelang == "uz"):?>
                            <div>
                                <h5>Jizzax politexnika instituti masofaviy ta'lim bo'yicha</h5>
                                <h1>Call-markazi</h1>
                            </div>
                            <div style="background: #CDD6DB; opacity: 0.9; padding: 5px;">
                                <h5 style="color: #0A246A;">Arxitektura va qurilish fakulteti <br>94-199-22-33 Sultonov Mansur</h5><br>
                                <h5 style="color: #0A246A;">Transport fakulteti <br>97-793-33-01 Sharipov Sanjar</h5><br>
                                <h5 style="color: #0A246A;">Servis fakulteti <br>93-613-85-55 Axmedov Erkin</h5><br>
                                <h5 style="color: #0A246A;">Sanoat texnologiyalari fakulteti <br>90-007-08-81 Xolmurodov Oybek</h5><br>
                                <h5 style="color: #0A246A;">Kimyo texnologiyalari fakulteti <br>91-198-43-57 Abdurasulov Farxod</h5><br>
                                <h5 style="color: #0A246A;">Qurilish materiallari fakulteti <br>93-290-34-34 Xudoyqulov Nuriddin</h5><br>
                                <h5 style="color: #0A246A;">Energetika va radioelektronika fakulteti <br>93-613-53-54 Abdullayev Elnur</h5><br>
                                <h5 style="color: #0A246A;">Sirtqi bo'lim <br>97-771-40-21 Xolboyev Eliyor</h5><br>
                            </div>
                        <?elseif($sitelang == "ru"):?>
...
<div class="information-banner wow fadeInUp">
    <div class="container">
        <?if($sitelang == "uz"):?>
            <h2 class="useful">FOYDALI MA'LUMOTLAR</h2>
        <?elseif($sitelang == "ru"):?>
                ...
                <div class="item active">
                    <ul class="thumbnails">
                        <li class="col-sm-3">
                            <div class="fff">
                                <div class="thumbnail">
                                    <a href="https://www.gov.uz/uz"><img src="https://jizpi.uz/wp-content/uploads/2022/01/Student.jpg" alt=""></a>
                                </div>
                                <div class="capt">
                                    <?if($sitelang == "uz"):?>
                                        <h4>Hemis talabalar uchun yo'riqnoma</h4>
                                        <h4><a href="https://jizpi.uz/wp-content/uploads/2022/01/HEMIS-Student-manual.pdf">Yuklab olish</a></h4>
                                    <?elseif($sitelang == "ru"):?>
                                        <p>Hemis talabalar uchun yo'riqnoma</p>
                                        <h4><a href="https://jizpi.uz/wp-content/uploads/2022/01/HEMIS-Student-manual.pdf">Yuklab olish</a></h4>
                                    <?elseif($sitelang == "en"):?>
                                        <h4>Hemis talabalar uchun yo'riqnoma</h4>
                                        <h4><a href="https://jizpi.uz/wp-content/uploads/2022/01/HEMIS-Student-manual.pdf">Yuklab olish</a></h4>
                        ...
                        <li class="col-sm-3">
                            <div class="fff">
                                <div class="thumbnail">
                                    <a href="http://edu.uz/"><img src="https://jizpi.uz/wp-content/uploads/2022/01/teacher.jpg" alt=""></a>
                                </div>
                                <div class="capt">
                                    <?if($sitelang == "uz"):?>
                                        <h4>Hemis professor-o'qituvchilar uchun yo'riqnoma</h4>
                                        <h4><a href="https://jizpi.uz/wp-content/uploads/2022/01/HEMIS_ОТМ_ахборот_тизимидан_фойдаланиш_қўлланмаси.pdf">Yuklab olish</a></h4>
                                    <?elseif($sitelang == "ru"):?>
                                        <h4>Hemis professor-o'qituvchilar uchun yo'riqnoma</h4>
                                        <h4><a href="https://jizpi.uz/wp-content/uploads/2022/01/HEMIS_ОТМ_ахборот_тизимидан_фойдаланиш_қўлланмаси.pdf">Yuklab olish</a></h4>
                                    <?elseif($sitelang == "en"):?>
                        ...
                        <li class="col-sm-3">
                            <div class="fff">
                                <div class="thumbnail">
                                    <a href="https://strategy.gov.uz/uz"><img src="https://jizpi.uz/wp-content/uploads/2022/01/Student.jpg" alt=""></a>
                                </div>
                                <div class="capt">
                                    <?if($sitelang == "uz"):?>
                                        <h4>Talabalarga</h4>
                                        <h4><a href="https://student.jizpi.uz/dashboard/login">Tizimga kirish</a></h4>
                                    <?elseif($sitelang == "ru"):?>
                                        <h4>Talabalarga</h4>
                                        <h4><a href="https://student.jizpi.uz/dashboard/login">Tizimga kirish</a></h4>
                                    <?elseif($sitelang == "en"):?>
                        ...
                        <li class="col-sm-3">
                            <div class="fff">
                                <div class="thumbnail">
                                    <a href="http://lex.uz/"><img src="https://jizpi.uz/wp-content/uploads/2022/01/teacher.jpg" alt=""></a>
                                </div>
                                <div class="capt">
                                    <?if($sitelang == "uz"):?>
                                        <h4>Professor-o'qituvchilarga</h4>
                                        <h4><a href="https://hemis.jizpi.uz/dashboard/login">Tizimga kirish</a></h4>
                                    <?elseif($sitelang == "ru"):?>
                                        <h4>Professor-o'qituvchilarga</h4>
                                        <h4><a href="https://hemis.jizpi.uz/dashboard/login">Tizimga kirish</a></h4>
                                    <?elseif($sitelang == "en"):?>
                ...
                <div class="item">
                    <ul class="thumbnails">
                        <li class="col-sm-3">
                            <div class="fff">
                                <div class="thumbnail">
                                    <a href="https://my.gov.uz/oz"><img src="https://jizpi.uz/wp-content/uploads/2022/01/2836056d71b74b8c871b41ec9841cec0.jpg" alt=""></a>
                                </div>
                                <div class="capt">
                                    <?if($sitelang == "uz"):?>
                                        <h4> Online dars jadvali</h4>
                                        <h4><a href="#">Yuklab olish</a></h4>
                                    <?elseif($sitelang == "ru"):?>
                                        <h4> Online dars jadvali</h4>
                                        <h4><a href="#">Yuklab olish</a></h4>
                                    <?elseif($sitelang == "en"):?>
                        ...
                        <li class="col-sm-3">
                            <div class="fff">
                                <div class="thumbnail">
                                    <a href="https://president.uz/uz"><img src="https://jizpi.uz/wp-content/uploads/2022/01/64b3a0deaf09072993611615628595.png" alt=""></a>
                                </div>
                                <div class="capt">
                                    <?if($sitelang == "uz"):?>
                                        <h4>So'rovnoma</h4>
                                        <h4><a href="https://docs.google.com/forms/d/18e2blk6CeqYXP9IsxxWS1Mq-fTzoUISjSYSoLHJB8RI/closedform">So'rovnomaga o'tish</a></h4>
                                    <?elseif($sitelang == "ru"):?>
                                        <h4>So'rovnoma</h4>
                                        <h4><a href="https://docs.google.com/forms/d/18e2blk6CeqYXP9IsxxWS1Mq-fTzoUISjSYSoLHJB8RI/closedform">So'rovnomaga o'tish</a></h4>
                                    <?elseif($sitelang == "en"):?>
						...
						<li class="col-sm-3">
                            <div class="fff">
                                ...
                                <div class="capt">
                                    <?if($sitelang == "uz"):?>
                                        <h4>Oliy ta’limda masofaviy o‘qitish sifati bo‘yicha talabalardan so‘rovnoma</h4>
                                        <h4><a href="https://docs.google.com/forms/d/18e2blk6CeqYXP9IsxxWS1Mq-fTzoUISjSYSoLHJB8RI/closedform">So'rovnomaga o'tish</a></h4>
                                    <?elseif($sitelang == "ru"):?>
                                        <h4>Oliy ta’limda masofaviy o‘qitish sifati bo‘yicha talabalardan so‘rovnoma</h4>
                                        <h4><a href="https://docs.google.com/forms/d/18e2blk6CeqYXP9IsxxWS1Mq-fTzoUISjSYSoLHJB8RI/closedform">So'rovnomaga o'tish</a></h4>
